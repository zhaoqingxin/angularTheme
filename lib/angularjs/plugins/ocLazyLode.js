    ...
    function(e, n) {
        ...
        d.provider("$ocLazyLoad", ["$controllerProvider", "$provide", "$compileProvider", "$filterProvider", "$injector", "$animateProvider", function(d, f, p, m, v, y) {
            ...
            function $(n, r) {
                ...
                function i(n) {
                    return e.isArray(n) ? M(n.toString()) : e.isObject(n) ? M(D(n)) : e.isDefined(n) && null !== n ? M(n.toString()) : n
                }
                var a = n[2][0],
                    s = n[1],
                    c = !1;
                ...
                if (r) {
                    ...
                    for (a = 0, s = r.length; s > a; a++) if (u = r[a], e.isArray(u)) {
                        ...
                        if ("invoke" !== u[1]) l && e.isDefined(c) && c[u[1]].apply(c, u[2]);
                            ...
                            else if (e.isArray(u[2][0])) for (var f = 0, h = u[2][0].length; h > f; f++) e.isFunction(u[2][0][f]) && d(u[2][0][f])
                        }
                    }
                }
            }
            ...
            this.$get = ["$log", "$rootElement", "$rootScope", "$cacheFactory", "$q", function(n, o, t, a, c) {
                function d(e) {
                    var r = c.defer();
                    return n.error(e.message), r.reject(e), r.promise
                }
                var f, p = a("ocLazyLoad");
                return x || (n = {}, n.error = e.noop, n.warn = e.noop, n.info = e.noop), O.getInstanceInjector = function() {
                    return f ? f : f = o.data("$injector") || e.injector()
                }, u = function(e, r) {
                    b && t.$broadcast(e, r), x && n.info(e, r)
                }, {
                    _broadcast: u,
                    _$log: n,
                    ...
                    _getModule: function(e) {
                        try {
                            ...
                            throw (/No module/.test(n) || n.message.indexOf("$injector:nomod") > -1) && (n.message = 'The module "' + D(e) + '" that you are trying to load does not exist. ' + n.message), n
                        }
                    },
                    moduleExists: _,
                    _loadDependencies: function(n, r) {
                        var o, t, i, a = [],
                            s = this;
                        if (n = s._getModuleName(n), null === n) return c.when();
                        try {
                            o = s._getModule(n)
                        } catch (u) {
                            return d(u)
                        ...
                        return t = s.getRequires(o), e.forEach(t, function(o) {
                            ...
                            })) : d(new Error("Error: New dependencies need to be loaded from external files (" + o.files + "), but no loader has been defined."));
                            if (e.isArray(o)) {
                                var u = [];
                            ...
                            if (e.isDefined(o.files) && 0 !== o.files.length) {
                                if (!e.isDefined(s.filesLoader)) return d(new Error('Error: the module "' + o.name + '" is defined in external files (' + o.files + "), but no loader has been defined."));
                    ...
                    inject: function(n) {
                        ...
                        if (i.length > 0) {
                            var u = i.slice(),
                                d = function f(e) {
                                    z.push(e), S[e] = a.promise, t._loadDependencies(e, r).then(function() {
                                        try {
                                            l = [], L(O, z, r)
                                        } catch (e) {
                            ...
                            if (r && r.name && S[r.name]) return S[r.name];
                            a.resolve()
                        }
                        return a.promise
                    },
            ...
            return n.filesLoader = function(o) {
                ...
                var d = function(r) {
                    ...
                    if (e.isObject(r) && (d = r.type, r = r.path), c = l.get(r), e.isUndefined(c) || t.cache === !1) {
                        if (null !== (o = /^(css|less|html|htm|js)?(?=!)/.exec(r)) && (d = o[1], r = r.substr(o[1].length + 1, r.length)), !d) if (null !== (o = /[.](css|less|html|htm|js)?((\?|#).*)?$/.exec(r))) d = o[1];
                        else {
                ...
                if (s.length > 0) {
                    ...
                    n.jsLoader(s, function(r) {
                        e.isDefined(r) && n.jsLoader.hasOwnProperty("ocLazyLoadLoader") ? (n._$log.error(r), g.reject(r)) : g.resolve()
                    }, t), u.push(g.promise)
                }
                if (0 === u.length) {
                    var p = r.defer(),
