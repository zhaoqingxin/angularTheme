            ...
            return function(e) {
                ...
                function(e, t, n) {
                    ...
                    e.exports = function(e, t, n, r, v, h) {
                                ...
                                return i(r, {
                                        addToQueue: {
                                            value: function(e, t, n) {
                                                ...
                                                this.queue.length !== s && (this._onAfterAddingAll(a), this.progress = this._getTotalProgress()),
                                                    this._render(),
                                        ...
                                        _transformResponse: {
                                            value: function(e, t) {
                                                ...
                                                return u(n.defaults.transformResponse,
                                                    function(t) {
                                                        e = t(e, r)
                                                    }),
                                                    e
                                        ...
                                        _parseHeaders: {
                                            value: function(e) {
                                                ...
                                                return e ? (u(e.split("\n"),
                                                    function(e) {
                                                        r = e.indexOf(":"),
                                                            t = e.slice(0, r).trim().toLowerCase(),
                                                            n = e.slice(r + 1).trim(),
                                                        t && (i[t] = i[t] ? i[t] + ", " + n: n)
                                                    }), i) : i
                                            }
                                        ...
                                        _xhrTransport: {
                                            value: function(e) {
                                                var t = this,
                                                    ...
                                                    r = new g;
                                                if (this._onBeforeUploadItem(e), u(e.formData,
                                                        function(e) {
                                                            u(e,
                                                                function(e, t) {
                                                                    r.append(t, e)
                                                ...
                                                r.append(e.alias, e._file, e.file.name),
                                                    ...
                                                    n.onload = function() {
                                                        var r = t._parseHeaders(n.getAllResponseHeaders()),
                                                            ...
                                                            s = "_on" + o + "Item";
                                                        t[s](e, i, n.status, r),
                                                            t._onCompleteItem(e, i, n.status, r)
                                                    },
                                                    n.onerror = function() {
                                                        var r = t._parseHeaders(n.getAllResponseHeaders()),
                                                            i = t._transformResponse(n.response, r);
                                                        t._onErrorItem(e, i, n.status, r),
                                                            t._onCompleteItem(e, i, n.status, r)
                                                    },
                                                    n.onabort = function() {
                                                        var r = t._parseHeaders(n.getAllResponseHeaders()),
                                                            i = t._transformResponse(n.response, r);
                                                        t._onCancelItem(e, i, n.status, r),
                                                            t._onCompleteItem(e, i, n.status, r)
                                                    },
                                        ...
                                        _iframeTransport: {
                                            value: function(e) {
                                                var t = this,
                                                    ...
                                                    i = e._input;
                                                e._form && e._form.replaceWith(i),
                                                    e._form = n,
                                                    this._onBeforeUploadItem(e),
                                                    i.prop("name", e.alias),
                                                    u(e.formData,
                                                        function(e) {
                                                            u(e,
                                                    ...
                                                    r.bind("load",
                                                        function() {
                                                            ...
                                                            t._onSuccessItem(e, u, s.status, a),
                                                                t._onCompleteItem(e, u, s.status, a)
                                                        }),
                                                    n.abort = function() {
                                                        var o,
                                                            s = {
                                                        ...
                                                        r.unbind("load").prop("src", "javascript:false;"),
                                                            n.replaceWith(i),
                                                            t._onCancelItem(e, o, s.status, a),
                                                            t._onCompleteItem(e, o, s.status, a)
                                                    },
                                                    i.after(n),
                                                    n.append(i).append(r),
                                                    n[0].submit(),
                        ...
                        return _.prototype.isHTML5 = !(!m || !g),
                            _.isHTML5 = _.prototype.isHTML5,
                            _
                    },
                    ...
                    e.exports = function() {
                        var e = function() {
                            ...
                            return i(e, {
                                ...
                                _createFromObject: {
                                    value: function(e) {
                                        this.lastModifiedDate = s(e.lastModifiedDate),
                                            this.size = e.size,
                                            this.type = e.type,
                                            this.name = e.name
                                    }
                                        ...
                                        value: function(e) {
                                            ...
                                            if (t) {
                                                ...
                                                this._preventAndStop(e),
                                                    l(this.uploader._directives.over, this._removeOverClass, this),
                                                    this.uploader.addToQueue(t.files, n, r)
                                            }
                                        }
                                    },
                                    onDragOver: {
                    ...
                    e.exports = function(e, t, n) {
                        return {
                            link: function(r, i, o) {
                                ...
                                a.getOptions = e(o.options).bind(a, r),
